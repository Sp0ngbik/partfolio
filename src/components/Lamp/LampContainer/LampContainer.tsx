            ...
            >
                ...
                >
                    ...
                    <div
                        style={{
                            ...
                            bottom: 0,
                            zIndex: 20,
                            borderRadius:'0px 65% 0px 0px',
                            maskImage: 'linear-gradient(to bottom right, rgba(255,255,255,0.25), transparent)'
                        }}
                    />
                </motion.div>
                <div
                    style={{
                        ...
                        // backgroundColor: 'black', /* bg-slate-950 */
                ...
                <div
                    style={{
                        ...
                        height: '12rem', /* h-48 */
                        width: '100%',
                        backgroundColor: 'rgba(255, 255, 255, 0.1)', /* bg-transparent opacity-10 */
